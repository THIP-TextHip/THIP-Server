...
public interface UserJpaRepository extends JpaRepository<UserJpaEntity, Long>, UserQueryRepository {
    ...
    Optional<UserJpaEntity> findByUserIdAndStatus(Long userId, StatusType status);
    List<UserJpaEntity> findAllByUserIdInAndStatus(List<Long> userIds, StatusType status);
}
