...
public enum ErrorCode implements ResponseCode {
    ...
    BOOK_NOT_FOUND(HttpStatus.BAD_REQUEST, 80010, "존재하지 않는 책입니다."),
    BOOK_ALREADY_SAVED(HttpStatus.BAD_REQUEST, 80011, "이미 저장되어있는 책입니다."),
    BOOK_NOT_SAVED_CANNOT_DELETE(HttpStatus.BAD_REQUEST, 80012, "저장되어있지 않은 책은 저장삭제 할 수 없습니다."),
