...
class RecordTest {
    ...
    private konkuk.thip.roompost.domain.Record createWithCommentRecord() {
        return konkuk.thip.roompost.domain.Record.builder()
                .id(100L)
    ...
    private konkuk.thip.roompost.domain.Record createNotCommentRecord() {
        return konkuk.thip.roompost.domain.Record.builder()
                .id(100L)
    ...
    void validate_page_valid_range() {
        konkuk.thip.roompost.domain.Record record = konkuk.thip.roompost.domain.Record.withoutId("content", 1L, 10, false, 1L);
    ...
    void validate_page_lower_than_zero() {
        konkuk.thip.roompost.domain.Record record = konkuk.thip.roompost.domain.Record.withoutId("content", 1L, 0, false, 1L);
    ...
    void validate_page_bigger_than_total() {
        konkuk.thip.roompost.domain.Record record = konkuk.thip.roompost.domain.Record.withoutId("content", 1L, 25, false, 1L);
        InvalidStateException ex = assertThrows(InvalidStateException.class,
                () -> record.validatePage(20));
        assertInstanceOf(IllegalArgumentException.class, ex.getCause());
    ...
    void validate_overview_not_overview_no_exception() {
        konkuk.thip.roompost.domain.Record record = konkuk.thip.roompost.domain.Record.withoutId("content", 1L, 5, false, 1L);
    ...
    void validate_overview_page_is_book_page_count() {
        konkuk.thip.roompost.domain.Record record = konkuk.thip.roompost.domain.Record.withoutId("content", 1L, 100, true, 1L);
    ...
    void validate_overview_page_is_not_book_page_count() {
        konkuk.thip.roompost.domain.Record record = konkuk.thip.roompost.domain.Record.withoutId("content", 1L, 15, true, 1L);  // 15/20 = 0.75
        InvalidStateException ex = assertThrows(InvalidStateException.class,
    ...
    void decreaseCommentCount_belowZero_throws() {
        konkuk.thip.roompost.domain.Record record = createNotCommentRecord();
